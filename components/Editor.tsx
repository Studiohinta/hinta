    ...
    <div className="h-full w-full flex relative overflow-hidden">
      ...
      `}>
         {isSidebarOpen && (
            ...
            >
                <ChevronDoubleRightIcon className="w-4 h-4 text-gray-600 dark:text-gray-200" />
            </button>
         )}
            ...
            <div className="border-t dark:border-gray-700 pt-4 mt-6">
                ...
                {!isDrawing && (
                    <div className="p-1 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-around gap-1 mb-4">
                        ...
                        >
                           <PolygonIcon className="w-3.5 h-3.5" /> Polygon
                        </button>
                         <button 
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                         {hotspot.type === 'polygon' ? (
                            ...
                            <InfoIcon className="w-4 h-4 text-gray-500 dark:text-gray-400 flex-shrink-0" />
                         ) : (
                            <CameraIcon className="w-4 h-4 text-gray-500 dark:text-gray-400 flex-shrink-0" />
                         )}
